...
<body>
    <div class="min-h-screen">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex items-center space-x-4">
                        ...
                        <span class="text-gray-500">/</span>
                        <span class="text-gray-700 font-medium">Edit Route</span>
                    </div>
                    <div class="flex items-center space-x-4">
                        <span class="text-gray-700">Welcome, {{ auth()->user()->name }}</span>
                        <a href="{{ route('admin.routes.show', $route) }}" class="navigation-link">
                            ← Back to Route
                        </a>
        ...
        <main class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
            ...
            <!-- Header Section -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-white">Edit Route</h1>
                <p class="text-blue-100 mt-2">Update route information and settings</p>
            </div>

            <!-- Current Route Info -->
            <div class="route-info">
                <h3>Current Route</h3>
                <p>{{ $route->from_location }} → {{ $route->to_location }}</p>
            </div>
                ...
                <form method="POST" action="{{ route('admin.routes.update', $route) }}">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="number" 
                                   ...
                                   value="{{ old('estimated_fare', $route->estimated_fare) }}"
                                   placeholder="0.00"
                                   step="0.01"
                                   min="0">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="description" 
                                  ...
                                  placeholder="Enter route description, notes, or special instructions...">{{ old('description', $route->description) }}</textarea>
                        @error('description')
                            <p class="error-text">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <p class="help-text">Check this box to make the route available for trips</p>
                    </div>

                    <div class="flex justify-end space-x-4 mt-8">
                        <a href="{{ route('admin.routes.show', $route) }}" class="btn-secondary">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
