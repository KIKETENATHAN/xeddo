            ...
            <div class="px-4 py-6 sm:px-0">
                ...
                <div class="mt-6 bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-md">
                    <div class="px-4 py-5 sm:px-6">
                        ...
                        <p class="mt-1 max-w-2xl text-sm text-gray-500 dark:text-gray-400">List of all registered users in the system</p>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            @if($user->role === 'driver' && $user->driverProfile)
                                                <a href="{{ route('admin.drivers.index') }}" class="text-indigo-600 hover:text-indigo-900">
                                                    View Profile
                                                </a>
                                            @endif
                                        </td>
