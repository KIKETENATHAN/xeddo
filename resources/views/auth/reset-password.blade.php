<x-guest-layout>
    <div class="text-center mb-6">
        <h2 class="text-xl font-bold text-primary mb-1">Reset Password</h2>
        <p class="text-gray-600 text-sm">Please enter your new password</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-4">
        ...
        <!-- Password -->
        <div>
            <label for="password" class="block text-sm font-semibold text-primary mb-2">New Password</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
