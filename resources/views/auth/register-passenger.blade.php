<x-guest-layout>
    <div class="text-center mb-8">
        <h2 class="text-2xl font-bold text-primary mb-2">Register as Passenger</h2>
        <p class="text-gray-600">Join thousands of passengers who travel comfortably with Xeddo</p>
    </div>

    <form class="space-y-6" action="{{ route('register.passenger.store') }}" method="POST">
        @csrf
