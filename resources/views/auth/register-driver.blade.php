<x-guest-layout>
    <div class="text-center mb-6">
        <h2 class="text-xl font-bold text-primary mb-1">Register as Driver</h2>
        <p class="text-gray-600 text-sm">Join Xeddo and start earning by driving passengers</p>
    </div>

    <form class="space-y-4" action="{{ route('register.driver.store') }}" method="POST">
        @csrf
