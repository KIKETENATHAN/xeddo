...
<head>
    ...
    <title>Register as Driver - Xeddo</title>
        ...
        <div class="max-w-md w-full space-y-8">
            <div>
                ...
                <p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                    Join Xeddo and start earning by driving
                </p>
            </div>
            
            <form class="mt-8 space-y-6" action="{{ route('register.driver.store') }}" method="POST">
                @csrf
            ...
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                    ...
                    <a href="{{ route('register.passenger') }}" class="font-medium text-blue-600 hover:text-blue-500">
