<x-guest-layout>
    <div class="text-center mb-4">
        <h2 class="text-lg font-bold text-primary mb-1">Welcome Back</h2>
        <p class="text-gray-600 text-xs">Sign in to your account to continue</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-3">
        ...
        <div class="flex items-center">
            <input id="remember_me" 
                   ...
                   name="remember">
            <label for="remember_me" class="ml-2 text-xs text-gray-600">Remember me</label>
        </div>
