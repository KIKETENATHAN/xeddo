...
<head>
    ...
    <title>Add New SACCO - Xeddo Admin</title>
...
<body class="hero-section">
    <div class="relative z-10">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        ...
                        <h1 class="text-xl font-bold text-primary">Add New SACCO</h1>
                    </div>
        ...
        <main class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 relative z-10">
            <!-- Header -->
            <div class="mb-8">
                <h2 class="text-3xl font-bold text-primary">Add New SACCO</h2>
                <p class="text-gray-600 mt-2">Create a new transportation cooperative</p>
            </div>

            <!-- Form -->
            <div class="card">
                <div class="p-8">
                    <form method="POST" action="{{ route('admin.saccos.store') }}" class="space-y-6" onsubmit="console.log('Form submitting...'); return true;">
                        @csrf
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name') }}" class="form-input" placeholder="Enter SACCO name" required>
                                @error('name')
                            ...
                            <div>
                                ...
                                <input type="tel" id="phone_number" name="phone_number" value="{{ old('phone_number') }}" class="form-input" placeholder="Enter phone number" required>
                                @error('phone_number')
                                    <div class="error-message">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="location" name="location" value="{{ old('location') }}" class="form-input" placeholder="Enter main location/headquarters" required>
                            @error('location')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" id="route_from" name="route_from" value="{{ old('route_from') }}" class="form-input" placeholder="Starting point" required>
                                @error('route_from')
                                    <div class="error-message">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" id="route_to" name="route_to" value="{{ old('route_to') }}" class="form-input" placeholder="Destination point" required>
                                @error('route_to')
                                    <div class="error-message">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="4" class="form-textarea" placeholder="Enter additional details about the SACCO">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="error-message">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="flex justify-end space-x-4">
                            ...
                            <button type="submit" class="btn-secondary" onclick="console.log('Create button clicked');">
